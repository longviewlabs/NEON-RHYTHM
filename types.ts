...
export const DIFFICULTIES: Record<Difficulty, LevelConfig> = {
    'EASY': { name: "VIBE CHECK", bpm: 100, length: 5, color: "text-green-400" },
    'MEDIUM': { name: "IN THE GROOVE", bpm: 120, length: 8, color: "text-yellow-400" },
    'HARD': { name: "HYPER FOCUS", bpm: 140, length: 12, color: "text-orange-500" },
    'NIGHTMARE': { name: "VIRTUOSO", bpm: 160, length: 15, color: "text-red-600" }
};
